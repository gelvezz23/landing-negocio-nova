$(document).ready(function () {
  ...
  $(".js-call-modal-two").click(function () {
    $(".modal").css("display", "none");
    $(".modalTwo").css("display", "block");
    $(".modalTwo").css("overflow-y", "hidden");
    $(".lds-ring").css("display", "none");

    var iframe = document.getElementById("myModalTwoFrame");

    iframe.src = iframe.src;
  });

  $(".js-call-modal-tres").click(function () {
    $(".modalTres").css("display", "block");
  });
